...
export default function StudentForm({ type, data }: StudentFormProps) {
    const {
        register,
        handleSubmit,
        formState: { errors },
        ...
        <form className='flex flex-col gap-4' onSubmit={onSubmit}>
            ...
            <div className='flex justify-between flex-wrap gap-4'>
                ...
                <div className='flex flex-col gap-2 w-full md:w-1/4'>
                    ...
                    {errors?.sex?.message &&
                        <p className='text-red-500 text-xs'>{errors.sex.message.toString()}</p>
                    }
                </div>
                <div className='flex flex-col gap-2 w-full md:w-1/4 justify-center'>
                    ...
                    {errors?.img?.message &&
                        <p className='text-red-500 text-xs'>{errors.img.message.toString()}</p>
                    }
                </div>
            </div>
